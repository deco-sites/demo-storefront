...
interface Props {
  ...
  policies?: Item[];
  logo?: ImageWidget;
  /** @description Alternative text for the logo image, used by screen readers */
  logoAlt?: string;
  trademark?: string;
}
      ...
      <div className="flex flex-col gap-8 py-10 sm:gap-10 sm:py-14">
        ...
        <div className="grid grid-flow-row gap-8 sm:grid-flow-col">
          ...
          <div className="flex flex-nowrap items-center justify-between gap-4 sm:justify-center">
            {logo && <img loading="lazy" src={logo} alt={logoAlt} className="h-5 w-auto" />}
